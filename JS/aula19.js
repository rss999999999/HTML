...
const nome = 'Luiz';
const nome1 = "Luiz";
const nome2 = `Luiz`;  //com crase posso usar templates screen ${}
const num1 =10; //number
const num2 = 10.52; //nummber

let nomeAluno; //posso criar sem inicializar a variável (undifined) -> não aponta para local nenhum na memória
let sobrenomeAluno = null //Nula -> não aponta para local nenhum na memória, todavia null é diferente de undefined
const sobrenomeAluno2 = null //Nula -> não aponta para local nenhum na memória, todavia null é diferente de undefined 
const boolean = true;
const buuleanu = false;
...
//console.log(typeof sobrenomeAluno, sobrenomeAluno); //aqui temos um bug, pois null não é um objeto
console.log(typeof buuleanu, buuleanu);

// as arrays mudam qndo usamos referência!
const a = [1,2]; //array
const b = a;
console.log(a,b);
b.push(3);  //estou adicionando um valor em b, e tmb ele está indo para a;
console.log(a,b) //[ 1, 2, 3 ] [ 1, 2, 3 ] //a e b apontam para o mesmo valor na memória, isso é passado por referência.



// as variáveis NÃO mudam qndo usamos referência!
let rodrigo = 2;
let kaio = rodrigo;
console.log(rodrigo,kaio);
rodrigo = 3;
console.log(rodrigo,kaio);
